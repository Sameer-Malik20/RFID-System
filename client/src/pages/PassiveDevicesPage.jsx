...
export function PassiveDevicesPage({ assets, passiveDevices }) {
  ...
  return (
    <div className="space-y-8 page-enter">
      ...
      <div className="grid items-start gap-6 xl:grid-cols-[1fr_0.95fr]">
        ...
        <div className="space-y-6">
          ...
          <DataTable
            title="Hooters / alarms"
            description="Alarm points and latest trigger records."
            rows={passiveDevices.hooters}
            columns={hooterColumns}
            searchableFields={["id", "location", "severity"]}
          />
        </div>
      </div>
    </div>
