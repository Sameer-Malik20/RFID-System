        ...
        <div className="panel min-w-0">
          ...
          <div className="mt-6 grid gap-4">
            ...
            <div className="grid gap-3 xl:grid-cols-2">
              <button
                type="button"
                className="min-w-0 rounded-[1.4rem] border border-[var(--color-shell-950)] bg-[var(--color-shell-950)] px-5 py-4 text-left text-white transition hover:-translate-y-0.5 hover:bg-[var(--color-brand-700)] focus:outline-none focus:ring-4 focus:ring-[rgba(12,111,168,0.14)]"
              ...
              <button
                type="button"
                className="min-w-0 rounded-[1.4rem] border border-[var(--color-line)] bg-white px-5 py-4 text-left text-[var(--color-ink-700)] transition hover:-translate-y-0.5 hover:border-[var(--color-brand-200)] hover:bg-[var(--color-brand-50)] focus:outline-none focus:ring-4 focus:ring-[rgba(12,111,168,0.10)]"
